        ...
        <div className={`user__container ${props.darkTheme && 'user_dark'}`}>
            ...
            <div className="user__data">
                <div className="user__info">
                    ...
                    <div className="info__line"><span className="info__title">Дата рождения: </span><span>{props.dateOfBirth && props.dateOfBirth.slice(0, 10)}</span></div>
                    <div className="info__line"><span className="info__title">Дата регистрации: </span><span>{props.registerDate && props.registerDate.slice(0, 10)}</span></div>
