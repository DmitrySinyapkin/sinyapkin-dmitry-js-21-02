...
const OpenPost = ({ darkTheme, id, avatar, ownerId, title, firstName, lastName, publishDate, picture, text, comments, total, commentsLoading, loadComments}) => {
        ...
        <div className={`open-post ${darkTheme && 'open-post_dark'}`}>
            <div className="open-post__header">
                <div className="open-post__owner">
                    ...
                    <HelperWrapper text={ownerId}>
                        <div className="comment__owner"><Link to={`/users/${ownerId}`}>{title ? `${title} ${firstName} ${lastName}` : `${firstName} ${lastName}`}</Link></div>
                    </HelperWrapper>
                </div>
                <div className="open-post__date">{publishDate}</div>
            </div>
            <figure><img src={picture} alt="Load error" /></figure>
